...
@interface MRTSessionController ()
...
@implementation MRTSessionController
...
- (instancetype)init
{
    ...
    if (self)
    {
        ...
        _peerID = [[MCPeerID alloc] initWithDisplayName:(NSString *)CFBridgingRelease(CFUUIDCreateString(NULL, udid))];
